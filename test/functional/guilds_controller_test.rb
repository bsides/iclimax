...
class GuildsControllerTest < ActionController::TestCase
  ...
  test "should create guild" do
    assert_difference('Guild.count') do
      post :create, guild: { achievementPoints: @guild.achievementPoints, battlegroup: @guild.battlegroup, level: @guild.level, name: @guild.name, realm: @guild.realm, side: @guild.side }
    end
  ...
  test "should update guild" do
    put :update, id: @guild, guild: { achievementPoints: @guild.achievementPoints, battlegroup: @guild.battlegroup, level: @guild.level, name: @guild.name, realm: @guild.realm, side: @guild.side }
    assert_redirected_to guild_path(assigns(:guild))
  end
